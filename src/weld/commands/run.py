...
def run_start(
    ...
    # Generate plan prompt (read-only operation, needed for both real and dry-run)
    ...
    if ctx.dry_run:
        ...
        ctx.console.print("  meta.json, spec.ref.json, plan.prompt.md")
        ctx.console.print("\n" + "=" * 60)
        ctx.console.print(plan_prompt)
